    ...
    <header className="sticky top-0 z-40 border-b border-border bg-background/95 backdrop-blur">
      <div className="mx-auto grid h-16 max-w-[1440px] grid-cols-[1fr_auto_1fr] items-center px-4 md:h-20 md:px-8">
        ...
        <nav className="hidden items-center gap-7 text-xs font-medium uppercase tracking-widest md:flex">
          <Link to="/shop" search={{ for: "women" }}>Women</Link><Link to="/shop" search={{ for: "men" }}>Men</Link><Link to="/shop" search={{ for: "new" }}>New</Link><Link to="/shop" search={{ for: "collections" }}>Collections</Link><Link to="/watch" search={{ story: "city-colour" }}>Watch</Link>
        </nav>
